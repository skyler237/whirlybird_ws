...
class Sliders:
    ...
    def __init__(self):
        ...
        self.Sforce = mySlider(self.num_of_sliders,1,6,0,5.22,1.0,'Force')
        self.Stau = mySlider(self.num_of_sliders,2,0.1,-0.1,0,1,'Tau')
    ...
    def getInputValues(self):
        ...
        # SECTION 3
        ################################################################              
        values = [self.Sforce.getValue(),self.Stau.getValue()]
        ################################################################
        return values
