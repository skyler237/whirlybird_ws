...
class Sliders:
    ...
    def __init__(self):
        ...
        self.Sphi = mySlider(self.num_of_sliders,1,
            180,-180,0,np.pi/180,'roll')
        self.Stheta = mySlider(self.num_of_sliders,2,
            90,-90,0,np.pi/180,'pitch')
        self.Spsi = mySlider(num_of_sliders = self.num_of_sliders,
            slider_number = 3, maxV = 360,minV = 0,intV =0,
            gain = np.pi/180, name ='yaw')
