...
class plotGenerator:
    ...
    def __init__(self):
        ...
        # Section 2
        ####################################################################
        self.handle.append(myPlot(self.ax[0][0],1,'t(s)', 'theta(m)', 'theta'))
        self.handle.append(myPlot(self.ax[0][1],1,'t(s)', 'theta error(m)', 'theta error'))
        self.handle.append(myPlot(self.ax[1][0],1,'t(s)', 'thetadot', 'thetadot'))
        self.handle.append(myPlot(self.ax[1][1],1,'t(s)', 'thetadot error', 'thetadot error'))
        self.handle.append(myPlot(self.ax[2][0],1,'t(s)', 'phi(m)', 'phi'))
        self.handle.append(myPlot(self.ax[2][1],1,'t(s)', 'phi error(m)', 'phi error'))
        self.handle.append(myPlot(self.ax[3][0],1,'t(s)', 'phidot', 'phidot'))
        self.handle.append(myPlot(self.ax[3][1],1,'t(s)', 'phidot error', 'phidot error'))
        self.handle.append(myPlot(self.ax[4][0],1,'t(s)', 'psi', 'psi'))
        self.handle.append(myPlot(self.ax[4][1],1,'t(s)', 'psi error', 'psi error'))
        self.handle.append(myPlot(self.ax[5][0],1,'t(s)', 'psidot', 'psidot'))
        self.handle.append(myPlot(self.ax[5][1],1,'t(s)', 'psidot error', 'psidot error'))
