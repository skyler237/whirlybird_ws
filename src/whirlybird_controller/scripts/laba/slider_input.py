...
class Sliders:
    ...
    def __init__(self):
        ...
        self.Sphi = mySlider(self.num_of_sliders,1,90,-90,0,np.pi/180,'phi')
        self.Stheta = mySlider(self.num_of_sliders,2,90,-90,0,np.pi/180,'theta')
        self.Spsi = mySlider(self.num_of_sliders,3,90,-90,0,np.pi/180,'psi')
